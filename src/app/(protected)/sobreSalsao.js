...
export default function Salsao() {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={{ uri: 'https://i0.wp.com/blog.cicloorganico.com.br/wp-content/uploads/2019/06/como-plantar-aipo-ou-salsacc83o.jpg?fit=973%2C481&ssl=1' }}
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Salsão</Text>
        <Text style={styles.title2}>Salsão ● Apium graveolens</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          O salsão, também conhecido como aipo, é uma planta da família Apiaceae, conhecida por seu sabor suave e propriedades nutritivas. É uma excelente fonte de vitamina K, fibras, e antioxidantes. É comumente usado em saladas, sopas e como ingrediente de sucos.
        </Text>
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Adicione fertilizante rico em potássio</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Pulgões e larvas</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A falta de água pode levar ao murchamento e ao crescimento atrofiado das plantas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Mantenha o solo úmido, regando regularmente.</Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/30.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Excesso de luz</Text>
            </View>
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O excesso de luz direta pode ressecar as folhas e prejudicar o crescimento.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Coloque a planta em local com sombra parcial ou filtrada.</Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Doenças fúngicas</Text>
            </View>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Doenças como míldio e oídio podem afetar a planta e diminuir sua produção.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Evite a umidade excessiva e use fungicidas específicos.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>É usado para adicionar sabor a sopas, caldos e sucos detox.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Benefícios para a saúde</Text>
              <Text style={styles.itemText2}>Melhora a digestão e tem propriedades anti-inflamatórias.</Text>
            </View>
          </View>   
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar o salsão, escolha um local com boa iluminação e um solo bem drenado. Regue regularmente para manter o solo úmido e use fertilizantes orgânicos para garantir um bom crescimento.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
