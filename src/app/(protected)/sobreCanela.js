    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/erv19.png')}
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Canela</Text>
        <Text style={styles.title2}>Canela ● Cinnamomum verum</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          A canela é uma especiaria extraída da casca interna de árvores do gênero *Cinnamomum*, originária do
          Sri Lanka e do sul da Índia. É amplamente usada na culinária e na medicina por suas propriedades
          aromáticas e de sabor.
        </Text>
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Pulgas e ácaros</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Folhas secas podem indicar falta de umidade ou problemas de rega.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Mantenha o solo levemente úmido e evite a exposição direta ao sol intenso por longos períodos.
              </Text>
            </View>
          )}
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O crescimento lento pode ser um sinal de deficiência de nutrientes ou pouca luz.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Aplique fertilizantes ricos em fósforo e mantenha a planta em um ambiente iluminado.
              </Text>
            </View>
          )}
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Manchas nas folhas podem ser um sinal de excesso de água ou fungos.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Reduza a frequência de rega e use um fungicida natural para tratar infecções fúngicas.
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Usos na culinária</Text>
              <Text style={styles.itemText2}>
                A canela é usada em doces, pratos salgados, chás e até como tempero para carnes.
              </Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>
                A canela tem propriedades anti-inflamatórias e antioxidantes, podendo ajudar na digestão.
              </Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.title2}>
          Para cultivar canela, siga as instruções abaixo:
        </Text>
        <Text style={styles.title2}>
          1. Plante em solo bem drenado e fértil, com uma leve acidez.
        </Text>
        <Text style={styles.title2}>
          2. Mantenha a planta em local com luz indireta e temperatura amena.
        </Text>
        <Text style={styles.title2}>
          3. Regue de forma moderada, mantendo o solo úmido, mas sem encharcar.
        </Text>
        <Text style={styles.title2}>
          4. A planta pode ser cultivada em vasos grandes e deve ser protegida do frio intenso.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
