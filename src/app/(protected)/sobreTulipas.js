    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/tulipa.png')} // Imagem da flor de tulipa
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Tulipa</Text>
        <Text style={styles.title2}>Tulipa sylvestris</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          A tulipa é uma planta perene, famosa por suas flores de pétalas elegantes e cores vibrantes. Originária da Ásia Central, ela é amplamente cultivada na Europa e se tornou um símbolo da primavera. Suas flores podem ser encontradas em diversas cores, como vermelha, amarela, roxa e branca.
        </Text>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>10°C - 18°C</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Durante a primavera</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Pulgões, lesmas e caracóis</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                As folhas amareladas podem ser um sinal de excesso de água ou falta de nutrientes no solo.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Garanta que o solo tenha boa drenagem e forneça fertilizante equilibrado.</Text>
            </View>
          )}
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O crescimento lento pode ser causado pela falta de luz ou por temperaturas muito altas ou baixas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Plante as tulipas em um local que receba sol pleno e mantenha uma temperatura amena.</Text>
            </View>
          )}
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                As folhas murchas podem ser causadas por falta de água ou doenças fúngicas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Regue adequadamente e evite o excesso de umidade nas folhas. Use fungicidas, se necessário.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Símbolo de amor e perfeição</Text>
              <Text style={styles.itemText2}>A tulipa é um símbolo de amor perfeito e tem sido associada à paixão em muitas culturas.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Origem histórica</Text>
              <Text style={styles.itemText2}>As tulipas foram trazidas para a Europa no século XVI e rapidamente se tornaram um símbolo de status na Holanda.</Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.title2}>
          1. Plante as tulipas no outono, antes da primeira geada, em solo bem drenado.
        </Text>
        <Text style={styles.title2}>
          2. Coloque as bulbos a uma profundidade de 10-15 cm, com a ponta voltada para cima.
        </Text>
        <Text style={styles.title2}>
          3. Regue levemente após o plantio e forneça sol pleno para um melhor crescimento.
        </Text>
        <Text style={styles.title2}>
          4. Após a floração, corte as flores secas, mas deixe as folhas crescerem para que o bulbo se fortaleça.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
