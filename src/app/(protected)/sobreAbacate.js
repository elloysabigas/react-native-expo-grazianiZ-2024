...
export default function Abacate() {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/frut12.png')} // Manter a imagem da página
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Abacate</Text>
        <Text style={styles.title2}>Abacate ● Persea americana</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          O abacate é uma fruta tropical rica em gorduras saudáveis, especialmente ácidos graxos monoinsaturados, que são benéficos para a saúde do coração. É versátil e pode ser usado em pratos doces e salgados, como guacamole, smoothies e saladas. Além de seu valor nutricional, o abacate contém vitaminas como a vitamina K, E, C e do complexo B.
        </Text>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O abacate é suscetível ao apodrecimento das raízes se for regado em excesso. O solo deve ser bem drenado para evitar esse problema.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Regue a planta somente quando o solo estiver seco ao toque. Evite encharcar o solo.</Text>
            </View>
          )}
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O abacate necessita de bastante luz para crescer forte e saudável. Sem luz suficiente, sua produção de frutos pode ser comprometida.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Certifique-se de que a planta receba pelo menos 6 horas de luz direta por dia.</Text>
            </View>
          )}
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O abacate precisa de um solo rico em nutrientes para se desenvolver de maneira ideal. Um solo pobre pode afetar a qualidade dos frutos.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Adicione composto orgânico e fertilizante balanceado ao solo para melhorar sua qualidade.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>O abacate é nativo do sul do México e foi cultivado por civilizações antigas como os astecas.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Além de ser uma fonte de gorduras saudáveis, o abacate é excelente para a saúde do coração e pode ajudar na absorção de nutrientes.</Text>
            </View>
          </View>   
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar abacate, use a semente do fruto. Lave-a bem e plante em solo fértil, com a metade da semente exposta acima do solo. Regue regularmente, mantendo o solo úmido, mas não encharcado.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
