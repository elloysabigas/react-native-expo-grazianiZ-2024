...
export default function Tomilho() {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/erv14.png')}
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Tomilho</Text>
        <Text style={styles.title2}>Tomilho ● Thymus vulgaris</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          O tomilho é uma planta aromática da família Lamiaceae, conhecida pelo seu sabor forte e picante. É amplamente utilizado na culinária para temperar carnes, sopas e molhos, além de ser um ingrediente essencial em muitos pratos mediterrâneos. Possui propriedades medicinais, sendo usado para aliviar tosses e problemas respiratórios.
        </Text>
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Pulgões e moscas-brancas</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Solo encharcado</Text>
            </View>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O solo encharcado pode causar apodrecimento das raízes, prejudicando a saúde da planta e reduzindo sua vida útil.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Certifique-se de que o solo tenha boa drenagem e evite regar em excesso.</Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/30.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Exposição insuficiente ao sol</Text>
            </View>
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A falta de luz solar pode causar o crescimento excessivo de folhas, mas sem a concentração dos óleos essenciais.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Plante em uma área que receba sol direto por pelo menos 6 horas por dia.</Text>
            </View>
          )}
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Um solo pobre em nutrientes pode fazer com que a planta não se desenvolva corretamente.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Adicione matéria orgânica ou fertilizantes naturais para enriquecer o solo.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Usado em pratos mediterrâneos, como tempero para carnes e molhos.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Tem propriedades antissépticas e é usado para tratar problemas respiratórios.</Text>
            </View>
          </View>   
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar tomilho, siga as instruções abaixo:
        </Text>
        <Text style={styles.title2}>
          1. Escolha um local ensolarado e com boa drenagem.
        </Text>
        <Text style={styles.title2}>
          2. Plante em solo leve, enriquecido com matéria orgânica.
        </Text>
        <Text style={styles.title2}>
          3. Regue moderadamente, evitando encharcar o solo.
        </Text>
        <Text style={styles.title2}>
          4. Pode precisar de podas leves para manter a planta saudável e estimular o crescimento.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
