    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/frut22.png')} // Manter a imagem da página
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Limão</Text>
        <Text style={styles.title2}>Limão ● Citrus limon</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          O limão é uma fruta cítrica rica em vitamina C e antioxidantes. É conhecido por seu sabor ácido e refrescante e é utilizado em diversas preparações, como sucos, temperos e sobremesas. O limão possui propriedades que podem ajudar na digestão e fortalecer o sistema imunológico.
        </Text>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O limão pode sofrer com o apodrecimento das raízes se for regado em excesso. É importante manter um solo bem drenado e não encharcar a planta.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Regue apenas quando o solo estiver seco ao toque para evitar problemas de umidade excessiva.</Text>
            </View>
          )}
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O limão necessita de boa iluminação para crescer e se desenvolver adequadamente. A falta de luz pode comprometer a qualidade e a produção dos frutos.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O solo deve ser rico em matéria orgânica e ter boa drenagem. Um solo pobre em nutrientes pode prejudicar o crescimento e a saúde da planta.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Adicione composto orgânico e um fertilizante equilibrado para manter a planta saudável.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>O limão tem origem na Ásia e foi introduzido em outras partes do mundo pela conquista e exploração de novas terras.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>O limão é uma excelente fonte de vitamina C, que fortalece o sistema imunológico e combate radicais livres.</Text>
            </View>
          </View>   
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar limão, escolha uma muda saudável e plante em solo fértil, bem drenado e com boa exposição solar. Regue de forma moderada e evite encharcar. A planta pode precisar de podas periódicas para manter seu crescimento saudável e estimular a frutificação.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
