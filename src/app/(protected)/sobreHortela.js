    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/erv17.png')}
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Hortelã</Text>
        <Text style={styles.title2}>Hortelã ● Mentha</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          A hortelã é uma planta aromática e perene da família Lamiaceae, conhecida por suas folhas frescas e
          sabor refrescante. É amplamente utilizada em receitas culinárias, chás e como aromatizante em bebidas e
          produtos cosméticos.
        </Text>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Excesso de umidade</Text>
            </View>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O excesso de umidade pode causar apodrecimento das raízes e folhas, favorecendo doenças fúngicas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Regue a planta apenas quando o solo estiver seco ao toque e evite deixar água acumulada no fundo do vaso.
              </Text>
            </View>
          )}
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A falta de luz pode levar a um crescimento lento e folhas com menos sabor.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Coloque a planta em um local com luz indireta brilhante ou em um local que receba pelo menos 4 horas de sol
                por dia.
              </Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Solo muito ácido</Text>
            </View>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Um solo muito ácido pode prejudicar a absorção de nutrientes, afetando o crescimento e o sabor das folhas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>
                Adicione cal para elevar o pH do solo para uma faixa mais neutra e promova um melhor crescimento.
              </Text>
            </View>
          )}
        </View>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>
                A hortelã é usada em pratos salgados, doces e bebidas como chá e coquetéis.
              </Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>
                É conhecida por ajudar na digestão, aliviar dores de cabeça e melhorar o hálito.
              </Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.title2}>
          Para cultivar hortelã, siga estas instruções:
        </Text>
        <Text style={styles.title2}>
          1. Escolha um local que receba sol parcial para uma melhor produção de folhas.
        </Text>
        <Text style={styles.title2}>
          2. Use um solo fértil e bem drenado, evitando locais onde a água possa acumular.
        </Text>
        <Text style={styles.title2}>
          3. Regue a planta moderadamente, mantendo o solo úmido, mas não encharcado.
        </Text>
        <Text style={styles.title2}>
          4. Pode ser cultivada em vasos e é recomendável podar para evitar o crescimento descontrolado.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
