...
export default function AlhoPoró() {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/erv12.png')}
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Alho-poró</Text>
        <Text style={styles.title2}>Alho-poró ● Allium ampeloprasum</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          O alho-poró é uma planta da família Amaryllidaceae, muito apreciada por seu sabor suave e aroma semelhante ao do alho. É usado tanto em sopas quanto em pratos principais, oferecendo um toque especial a diversas receitas. Além de seu uso culinário, o alho-poró possui propriedades nutritivas e é uma excelente fonte de vitaminas e minerais.
        </Text>
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Adicione fertilizante nitrogenado a cada mês</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Pulgões e lagartas</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems1 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A falta de água pode causar estresse hídrico e prejudicar o crescimento do alho-poró, tornando suas folhas amareladas e secas.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Regue regularmente, mantendo o solo úmido, mas sem encharcar.</Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/30.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Excesso de fertilização</Text>
            </View>
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                O excesso de fertilizante pode causar o crescimento excessivo da planta e tornar o sabor menos agradável.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Use fertilizantes balanceados e siga as instruções de aplicação corretamente.</Text>
            </View>
          )}
          ...
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Solo compactado</Text>
            </View>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Um solo compactado pode dificultar a absorção de nutrientes e água pelas raízes, prejudicando o crescimento do alho-poró.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
              <Text style={styles.title2}>Solte o solo com uma ferramenta apropriada e adicione matéria orgânica para melhorar a drenagem.</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>O alho-poró é usado em sopas, caldos e pratos principais, como quiches e tortas.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              <Text style={styles.itemText}>Propriedades nutritivas</Text>
              <Text style={styles.itemText2}>É uma fonte rica em vitaminas A, C e K, além de minerais como ferro e manganês.</Text>
            </View>
          </View>   
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar alho-poró, siga os passos abaixo:
        </Text>
        <Text style={styles.title2}>
          1. Escolha um local com sol parcial.
        </Text>
        <Text style={styles.title2}>
          2. Plante em solo fértil, bem drenado e enriquecido com matéria orgânica.
        </Text>
        <Text style={styles.title2}>
          3. Mantenha o solo úmido, mas evite encharcar.
        </Text>
        <Text style={styles.title2}>
          4. Pode ser necessário realizar um desbaste para garantir espaço para o crescimento das plantas.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
