...
export default function Ameixa() {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/frut17.png')} // Imagem da página da ameixa
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Ameixa</Text>
        <Text style={styles.title2}>Ameixa ● Prunus domestica</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          A ameixa é uma fruta doce e suculenta, rica em fibras, vitaminas e minerais. É conhecida por suas propriedades antioxidantes e por ajudar na digestão. As ameixas podem ser consumidas frescas ou secas e são amplamente utilizadas em doces, compotas e receitas.
        </Text>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A ameixa precisa de boa iluminação para crescer saudável e produzir frutos de qualidade. A falta de luz pode afetar seu desenvolvimento e produtividade.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Para crescer bem, a ameixa necessita de um solo rico em nutrientes e com boa drenagem. Solo pobre pode impedir o crescimento adequado da planta.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>A ameixa é nativa da Europa e da Ásia, sendo cultivada em várias partes do mundo por seu sabor doce e usos culinários.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>Rica em fibras e antioxidantes, a ameixa é excelente para a saúde digestiva e pode ajudar a manter níveis saudáveis de colesterol.</Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar ameixas, escolha uma muda saudável em solo fértil e bem drenado, com boa exposição solar. Mantenha a planta irrigada moderadamente e adube regularmente com fertilizantes orgânicos.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
