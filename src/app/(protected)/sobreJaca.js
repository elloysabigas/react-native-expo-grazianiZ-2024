    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.imageWrapper}>
          ...
          <Image
            source={require('../../../src/assets/images/frut19.png')} // Imagem da página da jaca
            style={styles.fullWidthImage}
            resizeMode="cover"
          />
        </View>
        <Text style={styles.title}>Jaca</Text>
        <Text style={styles.title2}>Jaca ● Artocarpus heterophyllus</Text>

        <Text style={styles.aboutTitle}>Sobre</Text>
        <Text style={styles.title2}>
          A jaca é uma fruta tropical de grande porte, conhecida por seu sabor doce e polpa macia. É rica em fibras, vitaminas e minerais, e é usada em uma variedade de pratos, incluindo sobremesas e pratos salgados.
        </Text>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>25°C - 35°C</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
        ...
        <View style={styles.imageContainer2}>
          ...
          {showProblems2 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                A jaca precisa de boa iluminação para crescer saudável e produzir frutos de qualidade. A falta de luz pode afetar seu desenvolvimento e produtividade.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
          ...
          {showProblems3 && (
            <View style={styles.problemDetails}>
              <Text style={styles.aboutTitle}>Sobre</Text>
              <Text style={styles.title2}>
                Para crescer bem, a jaca necessita de um solo fértil e bem drenado. Solo pobre pode impedir o crescimento adequado da planta.
              </Text>
              <Text style={styles.aboutTitle}>Como cuidar</Text>
        ...
        <View style={styles.imageContainer2}>
          <View style={styles.imageItem}>
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>A jaca é nativa da Índia e é cultivada em regiões tropicais ao redor do mundo.</Text>
            </View>
          </View>
          <View style={styles.imageItem}>
            <Image style={styles.itemImage} source={require('../../../src/assets/images/41.jpg')} />
            <View style={styles.textContainer}>
              ...
              <Text style={styles.itemText2}>A jaca é rica em vitaminas A, C e B, além de conter potássio, que ajuda a manter a pressão arterial saudável.</Text>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.title2}>
          Para plantar a jaca, escolha um local com boa exposição solar e solo fértil. Regue regularmente, mas evite encharcar o solo para prevenir o apodrecimento das raízes.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
